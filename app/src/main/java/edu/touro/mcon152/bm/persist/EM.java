...
public class EM {
    ...
    public static EntityManager getEntityManager() {
        if (em == null) {
            ...
            {
                System.err.println("edu.touro.mcon152.bm.persist.EM: FATAL Error initializing persistence: " + jpe.getMessage());
            ...
            {
                System.err.println("edu.touro.mcon152.bm.persist.EM: FATAL Error initializing persistence: " + exc.getMessage());
                System.err.println("Make sure persistence.xml is accessible");
                System.exit(5);
            }
        }
