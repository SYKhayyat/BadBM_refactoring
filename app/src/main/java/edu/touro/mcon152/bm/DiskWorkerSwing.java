 ...
 * Swing using an instance of the edu.touro.mcon152.bm.DiskMark class.
 */

public class DiskWorkerSwing extends SwingWorker<Boolean, DiskMark> implements I_Disk_Worker{
    ...
    @Override
    public void cancelRun(boolean state){
        this.cancel(state);
    }

    @Override
    public void addDiskWorkerPropertyChangeListener(PropertyChangeListener listener) {
        // SwingWorker has this method built-in
